...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='STDMamba',
    ...
    parser.add_argument('--label_len', type=int, default=16, help='start token length') # no longer needed in inverted Transformers
    ...
    parser.add_argument('--devices', type=str, default='0', help='device ids of multile gpus')#0,1,2,3,4,5,6
    ...
    if args.is_training==1:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_dstate{}_lrate{}_batchsize{}_LD{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.model_id,
                args.model,
                args.data_path,
                args.features,
